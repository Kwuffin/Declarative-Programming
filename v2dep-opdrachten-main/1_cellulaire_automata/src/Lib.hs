...
rightMost (FocusList forward backward) = FocusList [] (addToRec backward forward)   -- Doe hetzelfde als bij 'leftMost', maar dan omgedraaid. Dus deze keer word 'forward' leeggemaakt i.p.v.
